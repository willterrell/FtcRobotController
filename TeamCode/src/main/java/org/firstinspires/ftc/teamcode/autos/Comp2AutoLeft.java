...
@Autonomous
@Config
public class Comp2AutoLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        StartToHighJunction startToHighJunction = new StartToHighJunction("high", hardwareHandler, Side.LEFT);
        ...
        HighJunctionToParking parking = new HighJunctionToParking("parking", hardwareHandler, parkingPosition, Side.LEFT);
